...
<body>
	...
	<table border="2">
		...
		<tr>
				...
				<td>${item.stu_createtime }</td>
				<td>${item.stu_updatetime }</td>
				<td>
					<a href="student!deletestu.action?ids=${item.stu_id }">删除</a>
					<a href="student!selectbyid.action?ids=${item.stu_id }">修改</a>
				</td>
			</tr>
		</c:forEach>
	</table>
